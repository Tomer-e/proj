...
def debug_test(filename,k, to_log_file=False):
    local_K = 2
    print("local K = ", local_K)
    network, input_op_names, output_op_name = create_network(filename,local_K)

    print ("network.inputVars = ", network.inputVars)
    print ("network.inputVars[0] = ", network.inputVars[0])
    print ("network.inputVars[0][0] = ", network.inputVars[0][0])
    print ("network.inputVars[0][0][0] = ", network.inputVars[0][0][0])
